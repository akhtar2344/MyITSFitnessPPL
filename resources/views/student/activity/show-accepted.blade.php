...
<head>
  ...
  <title>Activity Detail (Accepted) | myITS Fitness</title>
            ...
            <div class="col-span-12 xl:col-span-8 rounded-2xl bg-white border shadow-sm overflow-hidden">
              <div class="p-6">
                ...
                <div class="mt-6 grid grid-cols-2 gap-y-3 text-sm md:text-base">
                  <div class="text-slate-500">Submitted:</div><div class="font-medium">October 2, 2024</div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <img src="{{ asset('images/harrystyles-proof2.png') }}"
                         alt="Proof"
